...
export function GameStats({ totalPlayers, prizePool, gameStatus, currency }: GameStatsProps) {
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-green-600">
              {currency ? formatCurrencyWithSymbol(prizePool, currency as 'USD' | 'VES') : formatCurrency(prizePool)}
            </span>
          </div>
